...
import com.example.startuptourism.Adapter.TouResAdapter;
import com.example.startuptourism.Database.RoomDb.Entity.Reservation;
import com.example.startuptourism.R;
import com.example.startuptourism.databinding.FragmentTouResBinding;
import com.google.firebase.database.DataSnapshot;

import java.util.ArrayList;
import java.util.List;

public class TouResFragment extends Fragment implements TouResAdapter.ReservationClick {

    private FragmentTouResBinding root;
    private TouristHome a;
    private TouResAdapter touResAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = FragmentTouResBinding.inflate(inflater, container, false);
        ...
        root.rvReservationList.setAdapter(touResAdapter = new TouResAdapter(a, new ArrayList<>(), this));
        ...
        a.dbHelper.getReference().child("reservations").get().addOnSuccessListener(dataSnapshot -> {
            ...
            if (dataSnapshot != null) {
                for (DataSnapshot res : dataSnapshot.getChildren()) {
                    ...
                    if (reservation.getReserveUserTou().equals(a.user.getUsername())) {
            ...
            touResAdapter.refreshList(reservationList);
        });
    }
